...
@interface NewsPaperObject : KrollCoverageObject {
#else
@interface NewsPaperObject : KrollObject {
#endif
@private
...
extern NSString * NewsPaper$ModuleRequireFormat;
