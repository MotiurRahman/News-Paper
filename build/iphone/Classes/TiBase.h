...
// in simulator we redefine to format for NewsPaper Developer console
...
{\
	NSString * exceptionName = [@"org.newspaper." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.newspaper";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UINewsPaperNativeItemNone = -1, 
	UINewsPaperNativeItemSpinner = -2,
	UINewsPaperNativeItemProgressBar = -3,
	
	UINewsPaperNativeItemSlider = -4,
	UINewsPaperNativeItemSwitch = -5,
	UINewsPaperNativeItemMultiButton = -6,
	UINewsPaperNativeItemSegmented = -7,
	
	UINewsPaperNativeItemTextView = -8,
	UINewsPaperNativeItemTextField = -9,
	UINewsPaperNativeItemSearchBar = -10,
	
	UINewsPaperNativeItemPicker = -11,
	UINewsPaperNativeItemDatePicker = -12,
	
	UINewsPaperNativeItemInfoLight = -13,
	UINewsPaperNativeItemInfoDark = -14,
	
	UINewsPaperNativeItemDisclosure = -15,
	
	UINewsPaperNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all NewsPaper instances of
