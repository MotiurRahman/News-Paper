...
/**
 Base class for all NewsPaper views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the NewsPaper view hierarchy (such as wrapped iOS UIViews) was touched.
