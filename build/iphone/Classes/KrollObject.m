...
//@interface NewsPaperObject : NSObject
//@end

@interface NewsPaperObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[NewsPaperObject class]])
		{
			for (NSString *key in [[(NewsPaperObject*)o modules] allKeys])
			{
